...
precio_base = float(input("Ingresa el precio base del producto en pesos chilenos: "))
distancia_km = float(input("Ingresa la distancia de envío en kilómetros: "))
...
def formatear_pesos(monto):
    """Convierte el monto a formato de pesos chilenos con separador de miles y decimales."""
    texto = f"{monto:,.2f}"
